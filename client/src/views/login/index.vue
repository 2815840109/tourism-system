                        ...
                        <div class="form-group mb-4">
                            <el-input type="text" v-model="form.pagerandom" name="pagerandom" class="form-control form-control-lg" id="pagerandom" placeholder="验证码">
                                <span class="input-group-append" slot="append">
                                    <e-img :src="captchUrl" style="min-width: 60px;min-height: 30px;" @click="refreshCaptcha" alt="点击刷新"/>
                                </span>
                            </el-input>
                        </div>
                        <div class="form-group mb-4">
...
export default {
    ...
    methods: {
        ...
        refreshCaptcha() {
            this.captchUrl = 'captcha.do?time=' + new Date().getTime();
        }
    },
    created() {
